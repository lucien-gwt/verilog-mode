...
(eval-when-compile
  (defun verilog-regexp-words (a)
    ...
    (concat "\\_<" (verilog-regexp-opt a t) "\\_>")))
(defun verilog-regexp-words (a)
  "Call `regexp-opt' with word delimiters for the words A."
...
(defconst verilog-directive-begin
  "\\_<`\\(for\\|i\\(f\\|fdef\\|fndef\\)\\|switch\\|while\\)\\_>")

(defconst verilog-directive-middle
  "\\_<`\\(else\\|elsif\\|default\\|case\\)\\_>")

(defconst verilog-directive-end
  "`\\(endfor\\|endif\\|endswitch\\|endwhile\\)\\_>")
...
;;
(defconst verilog-symbol-re      "\\_<[a-zA-Z_][a-zA-Z_0-9.]*\\_>")
;; Want to match
;; aa :
;; aa,bb :
;; a[34:32] :
...
(defconst verilog-property-re
  (concat "\\(" verilog-label-re "\\)?"
          ;; "\\(assert\\|assume\\|cover\\)\\s-+property\\_>"
          "\\(\\(assert\\|assume\\|cover\\)\\_>\\s-+\\_<property\\_>\\)\\|\\(assert\\)"))
...
(defconst verilog-ends-re
  ...
  (concat
   ...
   "\\(\\_<endtable\\_>\\)\\|"          ; 8
   "\\(\\_<endgenerate\\_>\\)\\|"         ; 9
   "\\(\\_<join\\(_any\\|_none\\)?\\_>\\)\\|" ; 10
   "\\(\\_<endclass\\_>\\)\\|"            ; 11
   "\\(\\_<endgroup\\_>\\)\\|"            ; 12
   ;; VMM
   "\\(\\_<`vmm_data_member_end\\_>\\)\\|"
   "\\(\\_<`vmm_env_member_end\\_>\\)\\|"
   "\\(\\_<`vmm_scenario_member_end\\_>\\)\\|"
   "\\(\\_<`vmm_subenv_member_end\\_>\\)\\|"
   "\\(\\_<`vmm_xactor_member_end\\_>\\)\\|"
   ;; OVM
   "\\(\\_<`ovm_component_utils_end\\_>\\)\\|"
   "\\(\\_<`ovm_field_utils_end\\_>\\)\\|"
   "\\(\\_<`ovm_object_utils_end\\_>\\)\\|"
   "\\(\\_<`ovm_sequence_utils_end\\_>\\)\\|"
   "\\(\\_<`ovm_sequencer_utils_end\\_>\\)"
   ;; UVM
   "\\(\\_<`uvm_component_utils_end\\_>\\)\\|"
   "\\(\\_<`uvm_field_utils_end\\_>\\)\\|"
   "\\(\\_<`uvm_object_utils_end\\_>\\)\\|"
   "\\(\\_<`uvm_sequence_utils_end\\_>\\)\\|"
   "\\(\\_<`uvm_sequencer_utils_end\\_>\\)"
   ))
...
(defconst verilog-end-block-ordered-re
  ;; Parenthesis indicate type of keyword found
  (concat "\\(\\_<endcase\\_>\\)\\|" ; 1
          "\\(\\_<end\\_>\\)\\|"     ; 2
          "\\(\\_<end"              ; 3, but not used
          "\\("                    ; 4, but not used
          "\\(function\\)\\|"      ; 5
          "\\(task\\)\\|"          ; 6
          "\\(module\\)\\|"        ; 7
...
(defconst verilog-endcomment-reason-re
  ...
  (concat
   "\\(\\_<begin\\_>\\)\\|"                      ; 1
   "\\(\\_<else\\_>\\)\\|"                       ; 2
   "\\(\\_<end\\_>\\s-+\\_<else\\_>\\)\\|"               ; 3
   "\\(\\_<always\\(?:_ff\\)?\\_>\\(?:[ \t]*@\\)\\)\\|"    ; 4 (matches always or always_ff w/ @...)
   "\\(\\_<always\\(?:_comb\\|_latch\\)?\\_>\\)\\|"  ; 5 (matches always, always_comb, always_latch w/o @...)
   "\\(\\_<fork\\_>\\)\\|"                       ; 7
   "\\(\\_<if\\_>\\)\\|"
   verilog-property-re "\\|"
   "\\(\\(" verilog-label-re "\\)?\\_<assert\\_>\\)\\|"
   "\\(\\_<clocking\\_>\\)\\|"
   "\\(\\_<task\\_>\\)\\|"
   "\\(\\_<function\\_>\\)\\|"
   "\\(\\_<initial\\_>\\)\\|"
...
(defconst verilog-beg-block-re-ordered
  ( concat "\\(\\_<begin\\_>\\)"                ;1
           "\\|\\(\\_<randcase\\_>\\|\\(\\_<unique0?\\s-+\\|priority\\s-+\\)?case[xz]?\\_>\\)" ; 2,3
           "\\|\\(\\(\\_<disable\\_>\\s-+\\|\\_<wait\\_>\\s-+\\)?fork\\_>\\)" ;4,5
           "\\|\\(\\_<class\\_>\\)"             ;6
           "\\|\\(\\_<table\\_>\\)"             ;7
           "\\|\\(\\_<specify\\_>\\)"           ;8
           "\\|\\(\\_<function\\_>\\)"          ;9
           "\\|\\(\\(?:\\_<\\(?:virtual\\|protected\\|static\\)\\_>\\s-+\\)*\\_<function\\_>\\)"  ;10
           "\\|\\(\\_<task\\_>\\)"                ;11
           "\\|\\(\\(?:\\_<\\(?:virtual\\|protected\\|static\\)\\_>\\s-+\\)*\\_<task\\_>\\)"      ;12
           "\\|\\(\\_<generate\\_>\\)"            ;13
           "\\|\\(\\_<covergroup\\_>\\)"          ;14
           "\\|\\(\\(?:\\(?:\\_<cover\\_>\\s-+\\)\\|\\(?:\\_<assert\\_>\\s-+\\)\\)*\\_<property\\_>\\)" ;15
           "\\|\\(\\_<\\(?:rand\\)?sequence\\_>\\)" ;16
           "\\|\\(\\_<clocking\\_>\\)"              ;17
           "\\|\\(\\_<`[ou]vm_[a-z_]+_begin\\_>\\)" ;18
           "\\|\\(\\_<`vmm_[a-z_]+_member_begin\\_>\\)"
           ;;
           ))

(defconst verilog-end-block-ordered-rry
  [ "\\(\\_<begin\\_>\\)\\|\\(\\_<end\\_>\\)\\|\\(\\_<endcase\\_>\\)\\|\\(\\_<join\\(_any\\|_none\\)?\\_>\\)"
    "\\(\\_<randcase\\_>\\|\\_<case[xz]?\\_>\\)\\|\\(\\_<endcase\\_>\\)"
    "\\(\\_<fork\\_>\\)\\|\\(\\_<join\\(_any\\|_none\\)?\\_>\\)"
    "\\(\\_<class\\_>\\)\\|\\(\\_<endclass\\_>\\)"
    "\\(\\_<table\\_>\\)\\|\\(\\_<endtable\\_>\\)"
    "\\(\\_<specify\\_>\\)\\|\\(\\_<endspecify\\_>\\)"
    "\\(\\_<function\\_>\\)\\|\\(\\_<endfunction\\_>\\)"
    "\\(\\_<generate\\_>\\)\\|\\(\\_<endgenerate\\_>\\)"
    "\\(\\_<task\\_>\\)\\|\\(\\_<endtask\\_>\\)"
    "\\(\\_<covergroup\\_>\\)\\|\\(\\_<endgroup\\_>\\)"
    "\\(\\_<property\\_>\\)\\|\\(\\_<endproperty\\_>\\)"
    "\\(\\_<\\(rand\\)?sequence\\_>\\)\\|\\(\\_<endsequence\\_>\\)"
    "\\(\\_<clocking\\_>\\)\\|\\(\\_<endclocking\\_>\\)"
    ] )
...
(defconst verilog-optional-signed-range-re
  (concat
   "\\s-*\\(\\_<\\(reg\\|wire\\)\\_>\\s-*\\)?\\(\\_<\\(un\\)?signed\\_>\\s-*\\)?\\(" verilog-range-re "\\)?"))
...
(defconst verilog-dpi-import-export-re
  (eval-when-compile
    "\\(\\_<\\(import\\|export\\)\\_>\\s-+\"DPI\\(-C\\)?\"\\s-+\\(\\_<\\(context\\|pure\\)\\_>\\s-+\\)?\\([A-Za-z_][A-Za-z0-9_]*\\s-*=\\s-*\\)?\\_<\\(function\\|task\\)\\_>\\)"
    ))

(defconst verilog-default-clocking-re "\\_<default\\s-+clocking\\s-+[A-Za-z_][A-Za-z0-9_]*\\s-*;")
(defconst verilog-disable-fork-re "\\(disable\\|wait\\)\\s-+fork\\_>")
...
(defconst verilog-extended-complete-re
  ...
  (concat "\\(\\(\\_<extern\\s-+\\|\\_<\\(\\_<\\(pure\\|context\\)\\_>\\s-+\\)?virtual\\s-+\\|\\_<protected\\s-+\\|\\_<static\\s-+\\)*\\(\\_<function\\_>\\|\\_<task\\_>\\)\\)"
          "\\|\\(\\(\\_<typedef\\_>\\s-+\\)*\\(\\_<struct\\_>\\|\\_<union\\_>\\|\\_<class\\_>\\)\\)"
          "\\|\\(\\(\\_<\\(import\\|export\\)\\_>\\s-+\\)?\\(\"DPI\\(-C\\)?\"\\s-+\\)?\\(\\_<\\(pure\\|context\\)\\_>\\s-+\\)?\\([A-Za-z_][A-Za-z0-9_]*\\s-*=\\s-*\\)?\\(function\\_>\\|task\\_>\\)\\)"
...
(defconst verilog-preprocessor-re
  (eval-when-compile
    (concat
     ...
     "\\_<\\(`elsif\\|`ifn?def\\|`undef\\|`default_nettype\\|`begin_keywords\\)\\_>\\s-"
     "\\)\\|\\(?:"
     ;; `line number "filename" level
     "\\_<\\(`line\\)\\_>\\s-+[0-9]+\\s-+\"[^\"]+\"\\s-+[012]"
     "\\)\\|\\(?:"
     ...
     "\\_<\\(`timescale\\)\\_>\\s-+10\\{0,2\\}\\s-*[munpf]?s\\s-*/\\s-*10\\{0,2\\}\\s-*[munpf]?s"
     "\\)\\|\\(?:"
     ...
     (concat "\\_<\\(`define\\|`if\\)\\_>"  ; directive
             "\\s-+"  ; separator
...
(defvar verilog-font-state-label-face
  'verilog-font-state-label-face
  "Font to use for Verilog state labels")
(defface verilog-font-state-label-face
  '((((class color)
      (background light))
     (:foreground "Purple" :bold t ))
    (((class color)
...
(defvar verilog-font-op-face
  'verilog-font-op-face
  "Font to use for Verilog ops")
(defface verilog-font-op-face
  '((((class color)
      (background light))
     (:foreground "Purple" :bold t ))
    (((class color)
...
(defvar verilog-font-1-face
  'verilog-font-1-face
  "Font to use for 1")
(defface verilog-font-1-face
  '((((class color)
      (background light))
    ...
    (((class color)
     ...
     (:foreground "green" :bold t ))
    (t (:italic t)))
  "Font to use for Verilog 1"
  :group 'font-lock-highlighting-faces)

(defvar verilog-font-0-face
  'verilog-font-0-face
  "Font to use for 0")
(defface verilog-font-0-face
  '((((class color)
      (background light))
    ...
    (((class color)
     ...
     (:foreground "red" :bold t ))
    (t (:italic t)))
  "Font to use for Verilog 0"
  :group 'font-lock-highlighting-faces)

(defvar verilog-font-reg-face
  'verilog-font-reg-face
  "Font to use for reg")
(defface verilog-font-reg-face
  '((((class color)
      (background light))
     (:foreground "red" :bold t ))
    (((class color)
     ...
     (:foreground "red" :bold t ))
    (t (:italic t)))
  "Font to use for Verilog reg"
  :group 'font-lock-highlighting-faces)

(defvar verilog-font-reg-next-face
  'verilog-font-reg-next-face
  "Font to use for reg")
(defface verilog-font-reg-next-face
  '((((class color)
      (background light))
     (:foreground "red" :bold t ))
    (((class color)
     ...
     (:foreground "red" :bold t ))
    (t (:italic t)))
  "Font to use for Verilog reg next"
  :group 'font-lock-highlighting-faces)


(defvar verilog-font-in-face
  'verilog-font-in-face
  "Font to use for in")
(defface verilog-font-in-face
  '((((class color)
      (background light))
     (:foreground "red" :bold t ))
    (((class color)
     ...
     (:foreground "red" :bold t ))
    (t (:italic t)))
  "Font to use for Verilog in"
  :group 'font-lock-highlighting-faces)


(defvar verilog-font-out-face
  'verilog-font-out-face
  "Font to use for out")
(defface verilog-font-out-face
  '((((class color)
      (background light))
     (:foreground "red" :bold t ))
    (((class color)
...
(let* ((verilog-type-font-keywords
  ...
  (setq verilog-font-lock-keywords
        (list
         ...
         (concat "\\_<\\(" verilog-font-general-keywords "\\|"
         ...
         (cons (regexp-opt '("!" "~"
                             ...
                             "[" "]"
                             "{" "}"
                             ) nil) 'verilog-font-op-face)

         (list "[^2-9A-Za-z_]\\(1\\)[^2-9A-Za-z_]" 1 'verilog-font-1-face)
         (list "\\([0-9]*'[bhx]1+\\)" 1 'verilog-font-1-face t)
         
         (list "[^2-9A-Za-z_]\\(0\\)[^2-9A-Za-z_]" 1 'verilog-font-0-face)
         (list "\\([0-9]*'[bhx]0+\\)" 1 'verilog-font-0-face t)

         (list "\\_<\\([a-zA-Z0-9_]+_reg\\)\\_>" 1 'verilog-font-reg-face)
         (list "\\_<\\([a-zA-Z0-9_]+_q\\)\\_>" 1 'verilog-font-reg-face)
         (list "\\_<\\(r_[a-zA-Z0-9_]+\\)\\_>" 1 'verilog-font-reg-face)

         (list "\\_<\\([a-zA-Z0-9_]+_reg_next\\)\\_>" 1 'verilog-font-reg-next-face)
         (list "\\_<\\([a-zA-Z0-9_]+_d\\)\\_>" 1 'verilog-font-reg-next-face)

         (list "\\_<\\([a-zA-Z0-9_]+_[a-z]*i\\)\\_>" 1 'verilog-font-in-face)
         (list "\\_<\\([a-zA-Z0-9_]+_[a-z]*o\\)\\_>" 1 'verilog-font-out-face)
         
         ;; fontify state labels
         (list "^[ \t]*\\(`?[a-zA-Z_0-9]+\\) *:" 1 'verilog-font-state-label-face)

         ;; Fontify all types
         (cons (concat "\\_<\\(" verilog-font-grouping-keywords "\\)\\_>")
               (if verilog-highlight-grouping-keywords
                   'verilog-font-lock-grouping-keywords-face
                 'font-lock-type-face))
         (cons (concat "\\_<\\(" verilog-type-font-keywords "\\)\\_>")
               'font-lock-type-face)
         ;; Fontify Verilog-AMS keywords
         (cons (concat "\\_<\\(" verilog-ams-keywords "\\)\\_>")
               'verilog-font-lock-ams-face)))
  ...
  (setq verilog-font-lock-keywords-1
        (append verilog-font-lock-keywords
                (list
                 ...
                 (list
                  "\\_<\\(\\(macro\\|connect\\)?module\\|primitive\\|class\\|program\\|interface\\|package\\|task\\)\\_>\\s-*\\(\\sw+\\)"
                  '(1 font-lock-keyword-face)
                  '(3 font-lock-function-name-face 'prepend))
                 ;; Fontify function definitions
                 (list
                  (concat "\\_<function\\_>\\s-+\\(integer\\|real\\(time\\)?\\|time\\)\\s-+\\(\\sw+\\)" )
                  '(1 font-lock-keyword-face)
  ...
  (let ((reg)
    ...
    (cond
     ...
     ((looking-at verilog-end-block-re)
      (verilog-leap-to-head))
     ((looking-at "\\(endmodule\\_>\\)\\|\\(\\_<endprimitive\\_>\\)\\|\\(\\_<endclass\\_>\\)\\|\\(\\_<endprogram\\_>\\)\\|\\(\\_<endinterface\\_>\\)\\|\\(\\_<endpackage\\_>\\)\\|\\(\\_<endconnectmodule\\_>\\)")
      (cond
       ((match-end 1)
        (verilog-re-search-backward "\\_<\\(macro\\)?module\\_>" nil 'move))
       ((match-end 2)
        (verilog-re-search-backward "\\_<primitive\\_>" nil 'move))
       ((match-end 3)
        (verilog-re-search-backward "\\_<class\\_>" nil 'move))
       ((match-end 4)
        (verilog-re-search-backward "\\_<program\\_>" nil 'move))
       ((match-end 5)
        (verilog-re-search-backward "\\_<interface\\_>" nil 'move))
       ((match-end 6)
        (verilog-re-search-backward "\\_<package\\_>" nil 'move))
       ((match-end 7)
        (verilog-re-search-backward "\\_<connectmodule\\_>" nil 'move))
       (t
        (goto-char st)
        (backward-sexp 1))))
     (t
  ...
  (let ((reg)
    ...
    (cond
     ...
     ((looking-at verilog-beg-block-re-ordered)
      (cond
       ((match-end 1);
        ...
        (setq reg "\\(\\_<begin\\_>\\)\\|\\(\\_<end\\_>\\)" ))
       ((match-end 2)
        ;; Search forward for matching endcase
        (setq reg "\\(\\_<randcase\\_>\\|\\(\\_<unique0?\\_>\\s-+\\|\\_<priority\\_>\\s-+\\)?\\_<case[xz]?\\_>[^:]\\)\\|\\(\\_<endcase\\_>\\)" )
     ...
     ((looking-at (concat
      ...
      (cond
       ((match-end 1)
        (verilog-re-search-forward "\\_<endmodule\\_>" nil 'move))
       ((match-end 2)
        (verilog-re-search-forward "\\_<endprimitive\\_>" nil 'move))
       ((match-end 3)
        (verilog-re-search-forward "\\_<endclass\\_>" nil 'move))
       ((match-end 4)
        (verilog-re-search-forward "\\_<endprogram\\_>" nil 'move))
       ((match-end 5)
        (verilog-re-search-forward "\\_<endinterface\\_>" nil 'move))
       ((match-end 6)
        (verilog-re-search-forward "\\_<endpackage\\_>" nil 'move))
       ((match-end 7)
        (verilog-re-search-forward "\\_<endconnectmodule\\_>" nil 'move))
       (t
        (goto-char st)
        (if (= (following-char) ?\) )
            (forward-char 1)
  ...
  (when (boundp 'hs-special-modes-alist)
    (unless (assq 'verilog-mode hs-special-modes-alist)
      (setq hs-special-modes-alist
            (cons '(verilog-mode "\\_<begin\\_>" "\\_<end\\_>" nil
  ...
  (let (h)
    (while
        ...
        (not (or
              ...
              (not (or (looking-at "\\_<") (forward-word-strictly -1)))
              ;; stop if we see an assertion (perhaps labeled)
              (and
               (looking-at "\\(\\w+\\W*:\\W*\\)?\\(\\_<\\(assert\\|assume\\|cover\\)\\_>\\s-+\\_<property\\_>\\)\\|\\(\\_<assert\\_>\\)")
               (progn
                 (setq h (point))
                 (save-excursion
          ...
          (let ((nest 1))
            (while t
              (verilog-re-search-backward
               (concat "\\(\\_<module\\_>\\)\\|\\(\\_<connectmodule\\_>\\)\\|\\(\\_<randcase\\_>\\|\\_<case[xz]?\\_>[^:]\\)\\|"
                       "\\(\\_<endcase\\_>\\)\\_>")
               nil 'move)
              (cond
               ((match-end 4)
    ...
    (save-excursion
      (catch 'done
        (while (and
                (/= nest 0)
                (verilog-re-search-backward
                 "\\_<\\(module\\)\\|\\(connectmodule\\)\\|\\(generate\\)\\|\\(endgenerate\\)\\_>" nil 'move)
                (cond
...
(defun verilog-in-fork-region-p ()
  ...
  (let ((lim (save-excursion (verilog-beg-of-defun)  (point)))
    ...
    (save-excursion
      (while (and
              (/= nest 0)
              (verilog-re-search-backward "\\_<\\(fork\\)\\|\\(join\\(_any\\|_none\\)?\\)\\_>" lim 'move)
              (cond
               ((match-end 1) ; fork
                (setq nest (1- nest)))
               ((match-end 2) ; join
...
(defun verilog-in-deferred-immediate-final-p ()
  ...
  (and (looking-at "final")
       (verilog-looking-back "\\_<\\(?:assert\\|assume\\|cover\\)\\_>\\s-+" nil))
  )
        ...
        (let ((colon 0)
          ...
          (setq b
                (progn
                  (if
                      (verilog-re-search-backward
                       "\\_<\\(randcase\\|case[zx]?\\)\\_>\\|;\\|\\_<end\\_>" nil 'move)
                      (progn
                        (cond
                         ((match-end 1)
            ...
            (if (looking-at verilog-end-block-ordered-re)
                (cond
                             ...
                             ((looking-at verilog-endcomment-reason-re)
                              ...
                              (cond
                               (;- begin
                                ...
                                (save-excursion
                                  (if (and (verilog-continued-line)
                                           (looking-at "\\_<repeat\\_>\\|\\_<wait\\_>\\|\\_<always\\_>"))
                                      (progn
                                        (goto-char (match-end 0))
                                        (setq there (point))
                                        (setq str
                               ...
                               (;- else
                                (match-end 2)
                                (let ((nest 0)
                                      ( reg "\\(\\_<begin\\_>\\)\\|\\(\\_<end\\_>\\)\\|\\(\\_<if\\_>\\)\\|\\(assert\\)"))
                                  (catch 'skip
                 ...
                 (;- this is endclass, which can be nested
                  ...
                  ;;(goto-char there)
                  (let ((nest 0)
                        (reg "\\_<\\(\\(class\\)\\|\\(endclass\\)\\|\\(package\\|primitive\\|\\(macro\\)?module\\)\\)\\_>")
                        string)
                    (save-excursion
                      (catch 'skip
                        (while (verilog-re-search-backward reg nil 'move)
                  ...
                  (let (string reg (name-re nil))
                    ...
                    (cond
                     ((match-end 5)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<function\\_>\\)\\|\\(\\_<\\(endfunction\\|task\\|\\(macro\\)?module\\|primitive\\)\\_>\\)")
                      (setq name-re "\\w+\\(?:\n\\|\\s-\\)*[(;]"))
                     ((match-end 6)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<task\\_>\\)\\|\\(\\_<\\(endtask\\|function\\|\\(macro\\)?module\\|primitive\\)\\_>\\)")
                      (setq name-re "\\w+\\(?:\n\\|\\s-\\)*[(;]"))
                     ((match-end 7)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<\\(macro\\)?module\\_>\\)\\|\\_<endmodule\\_>"))
                     ((match-end 8)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<primitive\\_>\\)\\|\\(\\_<\\(endprimitive\\|package\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 9)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<interface\\_>\\)\\|\\(\\_<\\(endinterface\\|package\\|primitive\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 10)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<package\\_>\\)\\|\\(\\_<\\(endpackage\\|primitive\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 11)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<class\\_>\\)\\|\\(\\_<\\(endclass\\|primitive\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 12)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<covergroup\\_>\\)\\|\\(\\_<\\(endcovergroup\\|primitive\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 13)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<program\\_>\\)\\|\\(\\_<\\(endprogram\\|primitive\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ((match-end 14)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<\\(rand\\)?sequence\\_>\\)\\|\\(\\_<\\(endsequence\\|primitive\\|interface\\|\\(macro\\)?module\\)\\_>\\)"))
                     ...
                     ((match-end 17)  ; of verilog-end-block-ordered-re
                      (setq reg "\\(\\_<connectmodule\\_>\\)\\|\\_<endconnectmodule\\_>"))
...
Return a list of two elements: (INDENT-TYPE INDENT-LEVEL)."
  (save-excursion
    (let* ((starting_position (point))
           (case-fold-search nil)
           (par 0)
           (begin (looking-at "[ \t]*begin\\_>"))
           (lim (save-excursion (verilog-re-search-backward "\\(\\_<begin\\_>\\)\\|\\(\\_<\\(connect\\)?module\\_>\\)" nil t)))
           (structres nil)
           (type (catch 'nesting
          ...
          (cond
           ...
           ((looking-at verilog-beg-block-re-ordered)
            (cond
             ...
             ((looking-at "\\_<class\\|struct\\|function\\|task\\_>")
              ...
              (cond
               ((looking-at verilog-dpi-import-export-re)
                (throw 'continue 'foo))
               ((or
                 (looking-at "\\_<pure\\_>\\s-+\\_<virtual\\_>\\s-+\\(?:\\_<\\(local\\|protected\\|static\\)\\_>\\s-+\\)?\\_<\\(function\\|task\\)\\_>\\s-+")
                 ;; Do not throw 'defun for class typedefs like
                 ;;   typedef class foo;
                 (looking-at "\\_<typedef\\_>\\s-+\\(?:\\_<virtual\\_>\\s-+\\)?\\_<class\\_>\\s-+"))
                (throw 'nesting 'statement))
               ((looking-at verilog-beg-block-re-ordered)
                (throw 'nesting 'block))
               (t
...
(defun verilog-leap-to-case-head ()
  (let ((nest 1))
    (while (/= 0 nest)
      (verilog-re-search-backward
       (concat
        "\\(\\_<randcase\\_>\\|\\(\\_<unique0?\\s-+\\|priority\\s-+\\)?\\_<case[xz]?\\_>\\)"
        "\\|\\(\\_<endcase\\_>\\)" )
       nil 'move)
      (cond
       ((match-end 1)
  ...
  (let ((reg nil)
    ...
    (cond
     ((looking-at "\\_<end\\_>")
      ...
      (setq reg (concat "\\(\\_<begin\\_>\\)\\|\\(\\_<end\\_>\\)\\|"
                        "\\(\\_<endcase\\_>\\)\\|\\(\\_<join\\(_any\\|_none\\)?\\_>\\)" )))
     ((looking-at "\\_<endtask\\_>")
      ;; 2: Search back for matching task
      (setq reg "\\(\\_<task\\_>\\)\\|\\(\\(\\_<\\(virtual\\|protected\\|static\\)\\_>\\s-+\\)+\\_<task\\_>\\)")
      (setq nesting 'no))
     ((looking-at "\\_<endcase\\_>")
      (catch 'nesting
        (verilog-leap-to-case-head) )
      (setq reg nil) ; to force skip
      )

     ((looking-at "\\_<join\\(_any\\|_none\\)?\\_>")
      ;; 4: Search back for matching fork
      (setq reg "\\(\\_<fork\\_>\\)\\|\\(\\_<join\\(_any\\|_none\\)?\\_>\\)" ))
     ((looking-at "\\_<endclass\\_>")
      ;; 5: Search back for matching class
      (setq reg "\\(\\_<class\\_>\\)\\|\\(\\_<endclass\\_>\\)" ))
     ((looking-at "\\_<endtable\\_>")
      ;; 6: Search back for matching table
      (setq reg "\\(\\_<table\\_>\\)\\|\\(\\_<endtable\\_>\\)" ))
     ((looking-at "\\_<endspecify\\_>")
      ;; 7: Search back for matching specify
      (setq reg "\\(\\_<specify\\_>\\)\\|\\(\\_<endspecify\\_>\\)" ))
     ((looking-at "\\_<endfunction\\_>")
      ;; 8: Search back for matching function
      (setq reg "\\(\\_<function\\_>\\)\\|\\(\\(\\_<\\(virtual\\|protected\\|static\\)\\_>\\s-+\\)+\\_<function\\_>\\)")
      (setq nesting 'no))
     ;;(setq reg "\\(\\_<function\\_>\\)\\|\\(\\_<endfunction\\_>\\)" ))
     ((looking-at "\\_<endgenerate\\_>")
      ;; 8: Search back for matching generate
      (setq reg "\\(\\_<generate\\_>\\)\\|\\(\\_<endgenerate\\_>\\)" ))
     ((looking-at "\\_<endgroup\\_>")
      ;; 10: Search back for matching covergroup
      (setq reg "\\(\\_<covergroup\\_>\\)\\|\\(\\_<endgroup\\_>\\)" ))
     ((looking-at "\\_<endproperty\\_>")
     ...
     ((looking-at "\\_<endinterface\\_>")
      ;; 12: Search back for matching interface
      (setq reg "\\(\\_<interface\\_>\\)\\|\\(\\_<endinterface\\_>\\)" ))
     ((looking-at "\\_<endsequence\\_>")
      ;; 12: Search back for matching sequence
      (setq reg "\\(\\_<\\(rand\\)?sequence\\_>\\)\\|\\(\\_<endsequence\\_>\\)" ))
     ((looking-at "\\_<endclocking\\_>")
      ;; 12: Search back for matching clocking
      (setq reg "\\(\\_<clocking\\)\\|\\(\\_<endclocking\\_>\\)" )))
    (if reg
        (catch 'skip
          (if (eq nesting 'yes)
              (let (sreg)
   ...
   (;-- Could be 'case (foo)' or 'always @(bar)' which is complete
    ...
    (progn
      ...
      (let ((back (point)))
        ...
        (cond
         ;;XX
         ((looking-at "\\_<\\(always\\(_latch\\|_ff\\|_comb\\)?\\|case\\(\\|[xz]\\)\\|for\\(\\|each\\|ever\\)\\|i\\(f\\|nitial\\)\\|repeat\\|while\\)\\_>")
          (not (looking-at "\\_<randcase\\_>\\|\\_<case[xz]?\\_>[^:]")))
         ...
         (t
          ...
          (cond
           ((= (preceding-char) ?\@)
            ...
            (save-excursion
              (verilog-backward-token)
              (not (looking-at "\\_<\\(always\\(_latch\\|_ff\\|_comb\\)?\\|initial\\|while\\)\\_>"))))
           ((= (preceding-char) ?\#)
            (backward-char))
           (t t)))))))
  ...
  (if (save-excursion
      ...
      (progn
        (let ( (pt (point)) (pass 0))
          (verilog-backward-ws&directives)
          (verilog-backward-token)
          (if (looking-at (concat "\\_<constraint\\|coverpoint\\|cross\\|with\\_>\\|" verilog-in-constraint-re))
              (progn (setq pass 1)
                     (if (looking-at "\\_<with\\_>")
            ...
            (if (looking-at "\\_<\\w+\\_>\\|\\s-*(\\s-*\\S-+")
                (progn (verilog-beg-of-statement)
                       (if (and
                            ...
                            (looking-at (concat "\\_<\\(constraint\\|"
                                                "\\(?:\\w+\\s-*:\\s-*\\)?\\(coverpoint\\|cross\\)"
                                                "\\|with\\)\\_>\\|" verilog-in-constraint-re)))
                           (setq pass 1)))))
          (if (eq pass 0)
...
(defun verilog-at-struct-p ()
  ...
  (save-excursion
    (if (and (equal (char-after) ?\{)
             (verilog-backward-token))
        (looking-at "\\_<struct\\|union\\|packed\\|\\(un\\)?signed\\_>")
      nil)))
...
(defun verilog-at-struct-mv-p ()
  ...
  (let ((pt (point)))
    (if (and (equal (char-after) ?\{)
             (verilog-backward-token))
        (if (looking-at "\\_<struct\\|union\\|packed\\|\\(un\\)?signed\\_>")
...
BASEIND is the base indent to offset everything."
  ...
  (let ((pos (point-marker))
        (lim (save-excursion
               ...
               (verilog-re-search-backward "\\(\\_<begin\\_>\\)\\|\\(\\_<\\(connect\\)?module\\_>\\)\\|\\(\\_<task\\_>\\)" nil 'move)
               (point)))
        (ind)
        (val)
        (m1 (make-marker)))
...
(defvar verilog-toggle-completions nil
  "True means \\_<verilog-mode-map>\\[verilog-complete-word] should try all possible completions one by one.
...
TYPE is `module', `tf' for task or function, or t if unknown."
  ...
  (let ((verilog-str (concat (cond
                              ((eq type 'module) "\\_<\\(module\\|connectmodule\\)\\s +")
                              ((eq type 'tf) "\\_<\\(task\\|function\\)\\s +")
                              (t "\\_<\\(task\\|function\\|module\\|connectmodule\\)\\s +"))
                             "\\_<\\(" verilog-str "[a-zA-Z0-9_.]*\\)\\_>"))
        match)
  ...
  (let ((re (or (and verilog-indent-declaration-macros
    ...
    (while (and (< (point) end)
      ...
      (while (and (verilog-re-search-forward verilog-symbol-re decl-end t)
        ...
        (if (string-match (concat "\\_<" verilog-str) match)
            (if (or (null verilog-pred)
                    (funcall verilog-pred match))
                (setq verilog-all (cons match verilog-all)))))
      (forward-line 1)))
...
(defun verilog-keyword-completion (keyword-list)
  ...
  (mapcar (lambda (s)
            (if (string-match (concat "\\_<" verilog-str) s)
                (if (or (null verilog-pred)
...
With optional second ARG non-nil, STR is the complete name of the instruction."
  ...
  (concat "^\\s-*\\(function\\|task\\|module\\)[ \t]+\\(?:\\(?:static\\|automatic\\)\\s-+\\)?\\(" str "\\)\\_>"))
...
(defun verilog-within-translate-off ()
  ...
  (and (save-excursion
         (re-search-backward
          (concat "//.*" verilog-directive-regexp "\\(on\\|off\\)\\_>")
          nil t))
...
(defun verilog-start-translate-off (limit)
  ...
  (when (re-search-forward
         (concat "//.*" verilog-directive-regexp "off\\_>")
         limit t)
    (match-beginning 0)))
...
(defun verilog-end-translate-off (limit)
  ...
  (re-search-forward (concat
                      "//.*" verilog-directive-regexp "on\\_>") limit t))
        ...
        (cond
         ...
         ((looking-at "^\\s *`pragma\\s +protect\\s +begin_protected")
          (or (re-search-forward "^\\s *`pragma\\s +protect\\s +end_protected" nil t)
              (forward-line)))
         ((looking-at "^\\s *`protected\\_>")
          (or (re-search-forward "^\\s *`endprotected\\_>" nil t)
              (forward-line)))
         ((looking-at "(\\*")
...
(defun verilog-read-auto-constants (beg end-mod-point)
  ...
  (save-excursion
    (let (sig-list tpl-end-pt)
      (goto-char beg)
      (while (re-search-forward "\\_<AUTO_CONSTANT" end-mod-point t)
        (if (not (looking-at "\\s *("))
...
(defun verilog-read-auto-lisp-present ()
  ...
  (save-excursion
    (goto-char (point-min))
    (setq verilog-cache-has-lisp (re-search-forward "\\_<AUTO_LISP(" nil t))))
...
Must call `verilog-read-auto-lisp-present' before this function."
  ...
  (when verilog-cache-has-lisp
    (save-excursion
      (goto-char start)
      (while (re-search-forward "\\_<AUTO_LISP(" end t)
        (backward-char)
         ...
         (with-current-buffer (find-file-noselect filename)
           (save-excursion
             ...
             (while (and
                     ...
                     (verilog-re-search-forward-quick "\\_<\\(connectmodule\\|module\\|interface\\|program\\)\\_>" nil t)
...
(defun verilog-inject-arg ()
  ...
  (save-excursion
    (goto-char (point-min))
    (while (verilog-re-search-forward-quick "\\_<\\(connect\\)?module\\_>" nil t)
      (let ((endmodp (save-excursion
                       (verilog-re-search-forward-quick "\\_<end\\(connect\\)?module\\_>" nil t)
                       (point))))
...
(defun verilog-inject-sense ()
  ...
  (save-excursion
    (goto-char (point-min))
    (while (verilog-re-search-forward-quick "\\_<always\\s *@\\s *(" nil t)
      (let* ((start-pt (point))
    ...
    (when (and check-values
      ...
      (while check-values
        (setq vl-bits (verilog-string-replace-matches
                       (concat "\\_<" (nth 0 (car check-values)) "\\_>")
      ...
      (setq prereset-sigs (verilog-signals-from-signame
                           (save-excursion
                             (verilog-read-signals
                              (save-excursion
                                (verilog-re-search-backward-quick
                                 "\\(@\\|\\_<\\(begin\\|if\\|case[xz]?\\|always\\(_latch\\|_ff\\|_comb\\)?\\)\\_>\\)" nil t)
                                (point))
                              (point)))))
      (save-excursion
        (verilog-re-search-backward-quick "\\(@\\|\\_<\\(always\\(_latch\\|_ff\\|_comb\\)?\\)\\_>\\)" nil t)
  ...
  (save-excursion
    (let* ((params (verilog-read-auto-params 0 1))
      ...
      (save-excursion
        ...
        (or (verilog-re-search-backward-quick "/\\*AUTOUNDEF\\_>" end-pt t)
            (goto-char (point-min)))
